...
class ReferralStatSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id',
            'campaign',
            # Правка 8 из 8: было лишнее поле affiliate
            # 'affiliate',
            'referrals_number',
            'is_campaign_active',
            'total_earned',
