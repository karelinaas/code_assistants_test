...
from .views.somecompanygpt import ReferralStatsListAPIView as ReferralStatListViewSomeCompanyGPT
...
urlpatterns = [
    ...
    path('somecompanygpt', ReferralStatListViewSomeCompanyGPT.as_view(), name=ENDPOINT_NAME_SOMECOMPANYGPT),
]
